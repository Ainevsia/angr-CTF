...
def main(argv):
  ...
  # (!)
  address_to_check_constraint = 0x80493a4
  ...
  if simulation.found:
    ...
    # (!)
    constrained_parameter_address = buffer_addr
    ...
    # (!)
    constrained_parameter_desired_value = 'BMCCHUGEIQDYESGO' # :string (encoded)

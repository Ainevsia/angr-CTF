...
def main(argv):
  ...
  # (!)
  # buffer_pointer = claripy.BVV(0xdeadbeef, 4*8)
  buffer_pointer = 0xdeadbeef
  ...
  # (!)
  validate_function_address = base + 0x00129c
  ...
  # constrain eax
  # (!)
  check_constraint_address = base + 0x000134c
  ...
  if simulation.found:
    ...
    # (!)
    solution_state.add_constraints( solution_state.regs.eax != claripy.BVV(0, 4*8) )

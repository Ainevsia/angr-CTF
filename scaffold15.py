...
def main(argv):
  ...
  class ReplacementScanf(angr.SimProcedure):
    ...
    def run(self, format_string, f0, f1):
      ...
      for char in scanf1.chop(bits=8):
        ...
        # your solution.
        # (!)
        self.state.add_constraints(char >= b'A', char <= b'[')
      # ********IMPORTANT*********
  ...
  def check_puts(state):
    ...
    if state.solver.symbolic(puts_parameter):
      ...
      # address in .rodata.
      # (!)
      good_job_string_address = 0x444a5a5b # :integer, probably hexadecimal
  ...
  if simulation.found:
    ...
    solution1 = solution_state.solver.eval(solution_state.globals['solution1'],cast_to=bytes).decode()
